...
import com.spotify.oauth2.api.applicationApi.BeforeRefactor.PlaylistApiFive;
...
public class PlayListTests_Five {
    /* *****************************************************************************************
    *  ***************   LIST OF ITEMS REFACTORED IN THIS CLASS FILE  **************************
    *  *****************************************************************************************
    *
    *     DESCRIPTION OF CHANGES:
    *         - Introduction of generic post , get and update methods
    ...
    *  *****************************************************************************************/
    ...
    public void shouldBeAbleToCreatePlayList() {
        ...
        Response response = PlaylistApiFive.post(requestPlaylist);
    ...
    public void ShouldBeAbleToGetAPlaylist() {
        ...
        // using PlaylistApiFive generic methods
        Response response = PlaylistApiFive.get("4jbfp94u3gtpubg9uw");
    ...
    public void ShouldBeAbleToUpdateAPlaylist() {
        ...
        // using PlaylistApiFive generic methods
        Response response = PlaylistApiFive.update("4jbfp94u3gtpubg9uw", requestPlaylist);
        assertThat(response.getStatusCode(), equalTo(20));
    }
    ...
    public void ShouldNotBeAbleToCreateAPlaylistWithExpiredToken() {
        ...
        // using PlaylistApiFive generic methods
        Response response = PlaylistApiFive.post(invalid_token,requestPlaylist);
