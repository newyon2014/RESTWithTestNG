...
public class TokenManagerTwentyOne {
    /* *****************************************************************************************
     ...
     *         - added synchronized for getToken() method
     *         - a single token will be shared across all threads
     *         - no race condition between threads. Each thread will wait for other to release this method.
