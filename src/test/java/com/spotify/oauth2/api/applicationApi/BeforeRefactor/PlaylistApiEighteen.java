...
public class PlaylistApiEighteen {
    /* *****************************************************************************************
     *  ***************   LIST OF ITEMS REFACTORED IN THIS CLASS FILE  **************************
     *  *****************************************************************************************
     *
     *     DESCRIPTION OF CHANGES:
     *         - No change - included only for the RestResourceEighteen changes
   ...
   // static String access_token = "PMAK-5ff2d720d2a39a004250e5da-c658c4a8a1cee3516762cb1a51cba6c5e2";
    ...
    public static Response post(PlaylistEighteen requestPlaylist){
        return RestResourceEleven.post(Route.USERS + "/" + ConfigLoader.getInstance().getUser() + Route.PLAYLISTS,
                                  getToken(),requestPlaylist);
    }

    public static Response post(String token, PlaylistEighteen requestPlaylist){
    ...
    public static Response update(String playlistId, PlaylistEighteen requestPlaylist){
